...
<div class="col-md-9" style="padding:0">
	...
	<section class="container">
            ...
            <hr style="width:100%">
            <div class="d-flex">
                <input onkeyup="filter(this)" id="search-bar" type="text" class="form-control w-50 mr-auto" placeholder="Hledat uživatele...">
            ...
            <?php 
                ...
                echo ' <table id="users" class="table table-hover shadow">
                <thead>
                        <tr>
                    ...
                    while($user = mysqli_fetch_array($users_result)){
                        ...
                        <tr>
                            ...
                            <td><td style="width:12%;"><form action="" method="post"><i class="text-primary	fas fa-pen"></i><button class="text-primary action-link" name="edit" type="submit">Upravit</button><input name="id" type="hidden" value="' . $user['id'] . '"></form></td>
                            <td style="width:12%;"><form action="" method="post"><i class="text-primary far fa-trash-alt"></i><button class="text-primary action-link" name="delete" type="submit">Smazat</button><input name="id" type="hidden" value="' . $user['id'] . '"></form></td>
                        </tr>
                        ';
                    }     
                echo '
