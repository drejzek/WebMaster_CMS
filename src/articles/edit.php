  ...
  <div class="accordion-item">
    ...
    <div id="options" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      ...
      <input type="checkbox" name="field[0]" id="visible" <?php echo $visibled?> value="1">
                <label for="visible">Zobrazit článek</label>
                <br>
                <br>
                        ...
                        <div class="modal-content">
                          <div class="modal-body">
                              <div class="container-fluid border-bottom mb-3 d-flex">
                                <h4 class="lead mb-3 me-auto">Povolit zámek</h4>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                              </div>
                                <div class="form-check form-switch mb-3">
                                  <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault">
                                  <label class="form-check-label" for="flexSwitchCheckDefault">Uzamknout článek</label>
                                </div>
