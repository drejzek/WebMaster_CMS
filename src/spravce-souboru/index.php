...
$CONFIG = '{"lang":"it","error_reporting":false,"show_hidden":false,"hide_Cols":false,"theme":"light"}';
...
$root_path = $_SERVER['DOCUMENT_ROOT'] . "/exploreblog/img";

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/exploreblog/img';
