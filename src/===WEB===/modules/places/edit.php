...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#four">Náhled</a>
    </li>
  </ul>
...
<!--                       <hr style="width:100%">-->
            ...
            <br>
			    ...
			    <input class="form-control" type="text" id="place_identifier"  name="place_identifier" style="width: 100%" value="<?php echo $page['identifier']?>" required>
			     ...
			     <br>
			     <br>
                <h4>Popisek na mapě</h4>
                <textarea name="map_desc" id="texta" cols="30" rows="10"></textarea>
    ...
    <div id="options" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      ...
      <div class="form-check form-switch mb-3">
                ...
                <button class="btn btn-outline-danger" style="width:100%"><i class="far fa-trash-alt"></i> Smazat</button>
			     ...
			     <div class="bg-white tab-pane fadee px-5" id="four">
                    </div>
                </div>
                 <br>
                </div>
