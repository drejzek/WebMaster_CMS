...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#two">Obsah článku</a>
    </li>
    <li class="nav-item">
...
<!--                       <hr style="width:100%">-->
        <div class="form-group mb-3">
            ...
            <input class="form-control" type="text" id="page_name"  name="page_name" style="width: 84%" value="<?php echo $page['name']?>" onkeyup="PageURL()" required>
        </div>
