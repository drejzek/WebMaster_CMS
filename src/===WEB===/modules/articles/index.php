...
$sql_m = "SELECT MAX(id) AS id FROM articles";
...
//$sql = "SELECT * FROM articles WHERE subweb_id = '" . $_SESSION['web_id'] . "'";

  $sql_p = "SELECT * FROM articles";
  $page_result = mysqli_query($ccon,$sql_p);
  if($page_result->num_rows == 0){
    $p_exists = false;
    $msg = "<strong>Varování: </strong>nebyly nalezeny žádné Články! Nejprve Články vytvořte.";
...
if(isset($_POST['sel_move'])){
  for($i=0;$i<($maxId + 1);$i++){
    if(isset($_POST['page'][$i])){
      ...
      $sql_sm = "UPDATE `articles` SET `subweb_id`=$swid WHERE id='$id'";
...
if(isset($_POST['sel_del'])){
  for($i=0;$i<($maxId + 1);$i++){
    if(isset($_POST['page'][$i])){
      $id = $i;
      $sql_sd = "DELETE FROM `articles` WHERE `id`='$id'";
...
if(isset($_GET['success'])){
    ...
    if($_GET['success'] == 'pg_created'){
      if(isset($_GET['id'])){
        $sql_sections = "SELECT * FROM articles WHERE id = '" . $_GET['id'] . "'";
...
function Geta_secName($domain, $tpid){  
  ...
  $sql1 = "SELECT * FROM articles WHERE id='$tpid'";
...
<div class="col-md-10" style="padding:0">
  ...
  <div class="border-bottom d-flex">
      <h2 class="mb-2 mt-2 me-auto">Články</h1>
      <div class="mt-2">
        <div class="dropdown">
    ...
    <div class="modal fade pt-0" id="mSecAdmin">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-body">
            <div class="container-fluid mb-3 border-bottom d-flex">
              <h4 class="lead me-auto" id="mSecAdmin">Správa rubrik</h4>
              <button type="button" class="btn btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <button class="btn" data-bs-toggle="modal" data-bs-target="#mSecAdd">Přidat rubriku</button>
                <?php
              
              $sql_sec = "SELECT * FROM a_sections";
    ...
    <div class="modal fade pt-0" id="mSecAdd">
    ...
    <div class="modal fade pt-0" id="mSecEdit">
      <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <button type="button" class="close" data-dismiss="alert"></button>
            ...
            <br>
                <form method="post">
                <?php 
                                echo ' <table id="articles" class="table table-hover">
                                      <thead>
                                      <tr>
                                      <th><input type="checkbox" name="check_all" onclick="checkAll(this);"></th>
                                      <th>ID</th>
                                  ...
                                  while($page = mysqli_fetch_array($page_result)){
                                    ...
                                    <td style="width:20%;">' . Geta_secName($_SESSION['domain'], $page['id']) . '</td>
                  ...
                  <div class="modal fade" id="mpgAskDelete">
                    <div class="modal-dialog modal-md">
                      <div class="modal-content">
                        <!-- Modal Header -->
                        <div class="modal-header">
                          <h4 class="modal-title" id="test">Smazat Články</h4>
                          <button type="button" class="btn-close" data-dismiss="modal"></button>
                        </div>
                        
                        <!-- Modal body -->
                        <div class="modal-body">
                          <label for="">Opravdu si přejete smazat vybrané Články?</label>
                          <br>
                        </div>
                        <div class="modal-footer">
                  ...
                  <div class="modal fade" id="mpgAskMove">
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-header">
                              <h4 class="modal-title">Přesunout Články</h4>
                              <button type="button" class="btn-close" data-dismiss="modal"></button>
                            </div>
                            <div class="modal-body">
                              ...
                              <select class="form-select lg-3" style="width:75%; padding:5px;" name="page_webid" required>
                                ...
                                <?php
                                  $sql1 = "SELECT * FROM a_sectionss";
                                    $a_secs_result = mysqli_query($ccon,$sql1);
                                    while($sw = mysqli_fetch_array($a_secs_result)){
    ...
    <div class="modal fade" id="mfilter">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <!-- Modal Header -->
          <div class="modal-header">
            <h4 class="modal-title">Filtr Článků</h4>
            <button type="button" class="btn-close" data-dismiss="modal"></button>
          </div>
      ...
      <div class="modal-dialog modal-md">
          <div class="modal-content">
            <form action="add.php" method="post">
              <div class="modal-header">
                <h4 class="modal-title">Přidat článek</h4>
                <button type="button" class="btn-close" data-dismiss="modal"></button>
              </div>
              <div class="modal-body px-3">
                <div class="form-group mb-3">
                  ...
                  <br>
                  <input type="text" id="page_name"  name="page_name" onkeyup="PageURL()" required>
                </div>
                <div class="form-group">
                  <label for="page-move" class="form-label">Rubrika:</label>
                  <br>
                  <select class="form-select lg-3" name="wid" required>
...
function seraditTabulku() {
  var table = document.getElementById("articles"); // Nahraďte "mojeTabulka" ID svou vlastní hodnotou
